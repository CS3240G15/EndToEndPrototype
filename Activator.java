...
public class Activator extends Object{
	...
	private static DifferentialPilot pilot = new DifferentialPilot(2.25f, 5.5f, Motor.A, Motor.C);
	    ...
	    do {
	    	try {
	    		...
	    		if (opcode.equals("0011") && canMove){
	    			...
	    			System.out.println(seqnum);
	    			output = seqnum + " 1 " + TakeReading(input.substring(13,14));
	    			//ACK back 000 
	    		}
